        ...
        >
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              aria-describedby={
                errors.first_name ? "invite-first-name-error" : undefined
              }
              {...register("first_name")}
            />
            {errors.first_name && (
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              aria-describedby={
                errors.last_name ? "invite-last-name-error" : undefined
              }
              {...register("last_name")}
            />
            {errors.last_name && (
              ...
              render={({ field }) => (
                ...
                >
                  <SelectTrigger
                    ...
                    aria-describedby={
                      errors.role ? "invite-role-error" : undefined
                    }
                    className="w-full"
                  >
                    <SelectValue />
